  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ marginBottom: '0.75rem', padding: '0.75rem', border: '1px solid #BFBFBF', borderRadius: 4 }}
      >
      ...
      {showSolution ? (
        <div style={{ marginTop: '0.75rem', padding: '0.5rem', background: '#F5F5F5', borderRadius: 4 }}>
